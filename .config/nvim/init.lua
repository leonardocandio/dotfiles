...
-- Toggles locking cursor to the middle of the screen
...
vim.keymap.set('n', '<leader>yf', ':%y<cr>', { desc = 'Yank current buffer' })
...
--    :Lazy update
--
--  NOTE: All plugins have been moved to standalone files inside plugins folder. plugins/init.lua
--  contains plugins initially added by kickstart.nvim but ideally every plugin should have
--  its own file
--
require('lazy').setup({
  -- Plugins can be added with a link (or for a github repo: 'owner/repo' link).
  'tpope/vim-sleuth', -- Detect tabstop and shiftwidth automatically
  -- Or we can import a whole submodule
  { import = 'plugins' },
  --
}, {
  ui = {
